...
readnet spice ../xschem/simulation/icell.spice     $source
...
lvs "$layout $project" "$source $project" $::env(PDK_ROOT)/$::env(PDK)/libs.tech/netgen/sky130A_setup.tcl lvs.report -blackbox
