...
C {opin.sym} 100 -260 0 0 {name=p9 lab=Iout}
...
C {lab_pin.sym} 370 -300 3 0 {name=p14 sig_type=std_logic lab=Iout}
...
C {lab_pin.sym} 550 -300 3 0 {name=p20 sig_type=std_logic lab=Iout}
